...
### Fixed
- Corrigido o erro de `ModuleNotFoundError` no script `build_windows.bat` garantindo que o `PySide6` estará disponível no ambiente de construção do PyInstaller.
